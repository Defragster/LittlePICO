...
IntervalTimer Alpha;
#else
#define ARM_DWT_CYCCNT ESP.getCycleCount() // ARM_DWT_CYCCNT
#ifdef LED_BUILTIN
#undef LED_BUILTIN
#endif
...
#define F_CPU_ACTUAL 240000000
void digitalToggleFast( int whatPin ) {
  // LED_BUILTIN );
  static bool bState = false;
  bState != bState;
  digitalWrite( whatPin, bState );
}
#endif
char szTeensy[24] = "";
...
DATA_PLACE char title_text[] = "Verify secure code is running properly";
CODE_PLACE int isEncrypt() {
  int ok = 0;
#ifdef TEENSYDUINO
